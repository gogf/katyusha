...
func (c *krpcClient) ChainUnary(interceptors ...grpc.UnaryClientInterceptor) grpc.UnaryClientInterceptor {
...
func (c *krpcClient) ChainStream(interceptors ...grpc.StreamClientInterceptor) grpc.StreamClientInterceptor {
