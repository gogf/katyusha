...
func NewCustomTimer(h IHistogram, m IMeter) ITimer {
	if UseNilMetrics {
		return NilTimer{}
	}
...
// Snapshot is a no-op.
func (NilTimer) Snapshot() ITimer { return NilTimer{} }
...
func (t *StandardTimer) Snapshot() ITimer {
	t.mutex.Lock()
...
func (t *TimerSnapshot) Snapshot() ITimer { return t }
